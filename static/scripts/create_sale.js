        ...
        tblProducts = $('#tblProducts').DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    orderable: false,
                    render: function (data, type, row) {
                        return '<input type="text" name="stock" class="form-control form-control-sm input-sm" autocomplete="off" value="' + row.stock + '">';
                    }
                },
                {
                    targets: [-1],
...
function formatRepo(repo) {
    ...
    var option = $(
        ...
        '<b>Nombre:</b> ' + repo.description + '<br>' +
        '<b>Categoría:</b> ' + repo.category.description + '<br>' +
