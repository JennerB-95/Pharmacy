            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return '<input type="text" class="text-center form-control input-sm" autocomplete="off" name="cant" value="' + row.cant + '">';
...
$(function () {
    ...
    $('#formClient').on('submit', function (e) {
        ...
        submit_with_ajax(window.location.pathname, 'Notificación',
            '¿Estas seguro de realizar el siguiente registro?', parameters, function (response) {
