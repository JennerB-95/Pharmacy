        ...
        try:
            ...
            if action == 'search_products':
                ...
                with transaction.atomic():
                    ...
                    sale = Sale()
                    for e in vents['products']:
                        sale.earning = (float(e['subtotal']) - float(e['pvp_cmp'])*int(e['cant']))
                        print(float(e['subtotal']) - float(e['pvp_cmp'])*int(e['cant']))
                    ...
                    for i in vents['products']:
                        ...
                        # det.earnings = (float(i['subtotal']) - float(i['pvp_cmp'])*int(i['cant']))
                ...
                clients = Client.objects.filter(Q(names__icontains=term) | Q(surnames__icontains=term) | Q(nit__icontains=term))[0:10]
                for i in clients:
                    item = i.toJSON()
